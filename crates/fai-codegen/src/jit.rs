...
fn register_runtime(builder: &mut JITBuilder) {
    ...
    sym!("fai_console_write", rt::fai_console_write);
    ...
    sym!("fai_file_open_read", rt::fai_file_open_read);
    sym!("fai_file_open_write", rt::fai_file_open_write);
    sym!("fai_file_open_append", rt::fai_file_open_append);
    sym!("fai_file_read_chunk", rt::fai_file_read_chunk);
    sym!("fai_file_write_chunk", rt::fai_file_write_chunk);
    sym!("fai_file_close_reader", rt::fai_file_close_reader);
    sym!("fai_file_close_writer", rt::fai_file_close_writer);
